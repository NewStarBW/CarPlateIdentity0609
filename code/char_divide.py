...
# 设置输入文件夹和输出文件夹
input_folder = "../carIdentityData/cnn_char_train1"
train_folder = "../carIdentityData/cnn_char_train"
test_folder = "../carIdentityData/cnn_char_test"
